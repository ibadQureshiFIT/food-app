  ...
  const nextScreen = () => {
    ...
    return(
        ...
        <ScrollView style={styles.main}> 
           <Header bgColor="#F9F9F9" rightIcon="LocationGreen" RightLabel='Alqaim town, isb' leftIcon="BackArrow" 
           onclickLeftIcon={()=>navigation.navigate('CartPreview')}/>
          ...
          <Row>
           ...
           <PrimaryButton label="proceed" color={'white'} height={mvs(50)} onclick={toggleModal}/>
        </View>
    ...
    <PaymentComponent  title="Master card" AccountNumber="xxxx xxxx xxxx 4321" leftIcon="MasterCardLogo" rightIcon="RadioUnSelected" 
          />
           <PaymentComponent  title="Cash" AccountNumber="xxxx xxxx xxxx 4321" leftIcon="Cash" rightIcon="RadioSelected" 
          />
