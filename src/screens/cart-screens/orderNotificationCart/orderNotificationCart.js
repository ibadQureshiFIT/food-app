...
const OrderNotificationCart=({navigation})=>{
    return(
        <View style={styles.main}>
              <Header bgColor="#20D994" leftIcon="ArrowWhite" midLabel="Order Status" txtColor='white' midSecond="Invoice: 54321" onclickLeftIcon={()=>navigation.navigate('CartCheckout')}/>
              ...
              <PrimaryButton label="Track your order" color={'white'} height={mvs(60)} style={styles.btn} onclick={()=>navigation.navigate('OrderStatus')}/>
