  ...
  return (
    <View
      ...
      <View style={styles.needHelpContainer}>
        ...
        <DrawerHomeCard icon1={'Help center'}
          label1={'Help center'} containerStyle={styles.helpStyle} />
        <DrawerHomeCard icon1={'Help center'}
          label1={'Terms and conditions'} containerStyle={styles.helpStyle} />
        <DrawerHomeCard icon1={'Help center'}
          label1={'Privacy policy'} containerStyle={styles.helpStyle} />
      </View>
      <DrawerHomeCard icon1={location} label1={'Country'}
        icon2={flag} label2={'Germany'}
        containerStyle={[styles.countryStyle, styles.top]} />
      <DrawerHomeCard icon1={globe} label1={'Language'}
        label2={'English'} styles={styles.helpStyle}
...
const styles = StyleSheet.create({
  ...
  header: {
    height: mvs(120), width: width - 60, backgroundColor: colors.green,
